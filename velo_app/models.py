...
class WorkoutSession(models.Model):
    ...
    workout_type = models.CharField(max_length=50, choices=[('cardio', 'Cardio'), ('strength', 'Strength Training'), ('flexibility', 'Flexibility'), ('balance', 'Balance Training'), ('pilates', 'Pilates'), ('yoga', 'Yoga'), ('running', 'Running'), ('walking', 'Walking'), ('cycling', 'Cycling'), ('swimming', 'Swimming')])
...
class Challenge(models.Model):
    ...
    description = models.TextField()
    type = models.CharField(max_length=50, choices=[('steps', 'Steps'), ('distance', 'Distance covered'), ('calories', 'Calories Burned'), ('minutes', 'Active Minutes'), ('workouts', 'Workout Sessions')])
